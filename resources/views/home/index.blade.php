                ...
                <div class="content-outer">
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            ...
                            <a href="departments.html" class="theme-btn btn-style-two"><span class="btn-title">{{$carousel->btnTwo_name}}</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
{{--                        <div class="btn-box">--}}
{{--                            <a href="about-us.html" class="theme-btn btn-style-one"><span class="btn-title">About--}}
{{--                                    Us</span></a>--}}
{{--                            <a href="departments.html" class="theme-btn btn-style-two"><span class="btn-title">Our--}}
{{--                                    Services</span></a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
        ...
        <div class="row">
            ...
            <div class="images-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    ...
                    <figure class="image-1"><img src="{{asset('assets/home/images/resource/image-1.png')}}" alt="">
                    </figure>
                    <figure class="image-2"><img src="{{asset('assets/home/images/resource/image-2.png')}}" alt="">
                    </figure>
    ...
    <div class="auto-container">
        ...
        <div class="row">
            ...
            <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <figure class="image"><img src="{{asset('assets/home/images/resource/team-1.jpg')}}" alt="">
                    </figure>
            ...
            <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <figure class="image"><img src="{{asset('assets/home/images/resource/team-2.jpg')}}" alt="">
                    </figure>
                    <ul class="social-links">
                        <li><a href="#"><span class="fab fa-facebook"></span></a></li>
                        <li><a href="#"><span class="fab fa-linkedin-in"></span></a></li>
            ...
            <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <figure class="image"><img src="{{asset('assets/home/images/resource/team-3.jpg')}}" alt="">
                    </figure>
                    <ul class="social-links">
                        <li><a href="#"><span class="fab fa-facebook"></span></a></li>
                        <li><a href="#"><span class="fab fa-linkedin-in"></span></a></li>
            ...
            <div class="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <figure class="image"><img src="{{asset('assets/home/images/resource/team-4.jpg')}}" alt="">
                    </figure>
                    <ul class="social-links">
                        <li><a href="#"><span class="fab fa-facebook"></span></a></li>
                        <li><a href="#"><span class="fab fa-linkedin-in"></span></a></li>
        ...
        <div class="sec-bottom-text">Don’t hesitate, contact us for better help and services <a href="#">Explore all Dr.
                Team</a></div>
    </div>
</section>
<!-- End Team Section -->
            ...
            <div class="client-thumb-outer">
                <div class="client-thumbs-carousel owl-carousel owl-theme">
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{asset('assets/home/images/resource/testi-thumb-1.jpg')}}"
                                alt=""></figure>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{asset('assets/home/images/resource/testi-thumb-2.jpg')}}"
                                alt=""></figure>
                        <div class="author-info">
                            <span class="icon fa fa-quote-left"></span>
                            <div class="author-name">Lara Croft</div>
                    ...
                    <div class="thumb-item">
                        <figure class="thumb-box"><img src="{{asset('assets/home/images/resource/testi-thumb-3.jpg')}}"
                                alt=""></figure>
                        <div class="author-info">
                            <span class="icon fa fa-quote-left"></span>
                            <div class="author-name">Lara Croft</div>
        ...
        <div class="row">
                ...
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="blog-post-image.html"><img
                                    src="{{asset('assets/home/images/resource/news-1.jpg')}}" alt=""></a></figure>
            ...
            <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="blog-post-image.html"><img
                                    src="{{asset('assets/home/images/resource/news-2.jpg')}}" alt=""></a></figure>
                        <a href="#" class="date">Sep 19, 2020</a>
                    </div>
                    <div class="lower-content">
            ...
            <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image"><a href="blog-post-image.html"><img
                                    src="{{asset('assets/home/images/resource/news-3.jpg')}}" alt=""></a></figure>
                        <a href="#" class="date">Sep 19, 2020</a>
                    </div>
                    <div class="lower-content">
    ...
    <div class="auto-container">
        ...
        <div class="sponsors-outer">
            ...
            <ul class="clients-carousel owl-carousel owl-theme">
                <li class="slide-item"> <a href="#"><img src="{{asset('assets/home/images/clients/1.png')}}" alt=""></a>
                </li>
                <li class="slide-item"> <a href="#"><img src="{{asset('assets/home/images/clients/2.png')}}" alt=""></a>
                </li>
                <li class="slide-item"> <a href="#"><img src="{{asset('assets/home/images/clients/3.png')}}" alt=""></a>
                </li>
                <li class="slide-item"> <a href="#"><img src="{{asset('assets/home/images/clients/4.png')}}" alt=""></a>
                </li>
                <li class="slide-item"> <a href="#"><img src="{{asset('assets/home/images/clients/5.png')}}" alt=""></a>
                </li>
            </ul>
        </div>
    </div>
