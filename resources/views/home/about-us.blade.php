            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">
                        ...
                        <div class="link-box">
                            <figure class="signature"><img src="{{asset('assets/home/images/resource/signature.png')}}"" alt=""></figure>
                ...
                <div class="images-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <figure class="image-1"><img src="{{asset('assets/home/images/resource/image-1.png')}}"" alt=""></figure>
                        <figure class="image-2"><img src="{{asset('assets/home/images/resource/image-2.png')}}"" alt=""></figure>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="doctor-detail.html"><img src="{{asset('assets/home/images/resource/team-5.jpg')}}"
                                        alt=""></a></figure>
                ...
                <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="doctor-detail.html"><img src="{{asset('assets/home/images/resource/team-6.jpg')}}"
                                        alt=""></a></figure>
                            <ul class="social-links">
                                <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                ...
                <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="doctor-detail.html"><img src="{{asset('assets/home/images/resource/team-7.jpg')}}"
                                        alt=""></a></figure>
                            <ul class="social-links">
                                <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                <li><a href="#"><span class="fab fa-twitter"></span></a></li>
            ...
            <div class="sec-bottom-text">Don’t hesitate, contact us for better help and services. <a
                    href="#">Explore all Dr. Team</a></div>
        </div>
    </section>
    <!--End Team Section -->
            ...
            <div class="skill-column">
                <div class="inner-column">
                    ...
                    <div class="btn-box"><a href="#" class="theme-btn btn-style-three"><span
                                class="btn-title">Learn More</span></a></div>
                </div>
            </div>

            <div class="image-column" style="background-image: url(images/resource/image-7.jpg);">
                <div class="image-box">
                    <figure class="image"><img src="{{asset('assets/home/images/resource/image-7.jpg')}}" alt=""></figure>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="call-to-action">
                <div class="inner-container">
                    <div class="content-column">
                        ...
                        <a href="#" class="theme-btn btn-style-three"><span class="btn-title">Take
                                Appointment</span></a>
                    </div>
