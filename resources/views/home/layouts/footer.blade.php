                        ...
                        <div class="row">
                            ...
                            <div class="footer-column col-xl-7 col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget about-widget">
                                    <div class="logo">
                                        <a href="index.html"><img src="{{asset('assets/home/images/logo-2.png')}}" alt="" /></a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="footer-widget recent-posts">
                                    ...
                                    <div class="widget-content">
                                        <div class="post">
                                            <div class="thumb"><a href="blog-post-image.html"><img src="{{asset('assets/home/images/resource/post-thumb-1.jpg')}}" alt=""></a></div>
                                            <h4><a href="blog-post-image.html">Integrative Medicine <Br>& Cancer Treatment.</a></h4>
                                            <span class="date">July 11, 2020</span>
                                        </div>

                                        <div class="post">
                                            <div class="thumb"><a href="blog-post-image.html"><img src="{{asset('assets/home/images/resource/post-thumb-2.jpg')}}" alt=""></a></div>
                                            <h4><a href="blog-post-image.html">Achieving Better <br>Health Care Time.</a></h4>
                                            <span class="date">August 1, 2020</span>
                                        </div>

                                        <div class="post">
                                            <div class="thumb"><a href="blog-post-image.html"><img src="{{asset('assets/home/images/resource/post-thumb-3.jpg')}}" alt=""></a></div>
