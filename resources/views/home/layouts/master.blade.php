...
<head>
<meta charset="utf-8">
<title>Medicoz | Health and MedicalTemplate</title>
    ...
    <div class="inner-palate">
        ...
        <div class="demos-box">
            ...
            <ul class="single-item-carousel owl-carousel owl-theme demos-list">
                <li data-text="Home Medical"><a href="index.html"><img src="{{asset('assets/home/images/background/demos/1.png')}}" alt=""></a></li>
                <li data-text="Home Clanic"><a href="index-2.html"><img src="{{asset('assets/home/images/background/demos/2.png')}}" alt=""></a></li>
                <li data-text="Home Dental Care"><a href="index-3.html"><img src="{{asset('assets/home/images/background/demos/3.png')}}" alt=""></a></li>
                <li data-text="Home Eye Care"><a href="index-4.html"><img src="{{asset('assets/home/images/background/demos/4.png')}}" alt=""></a></li>
                <li data-text="Home Prenatal care"><a href="index-5.html"><img src="{{asset('assets/home/images/background/demos/5.png')}}" alt=""></a></li>
            </ul>
        </div>
        ...
        <div class="lower-options">
            ...
            <div class="box-mode-bg">
                ...
                <ul class="clearfix"> 
                    ...
                    <li style="background-image: url(assets/home/images/background/boxed-bg/4.png')}});"></li>
                    <li style="background-image: url(assets/home/images/background/boxed-bg/5.png')}});"></li>
                    <li style="background-image: url(assets/home/images/background/boxed-bg/6.png')}});"></li>
                    <li style="background-image: url(assets/home/images/background/boxed-bg/7.png')}});"></li>
                    <li style="background-image: url(assets/home/images/background/boxed-bg/8.png')}});"></li>
                </ul>
            </div>
